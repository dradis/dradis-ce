...
(function (global, factory) {
  ...
  var category20 = colors(
    '8A2BE2DC143C8B00000064008B4513008080696969A0522D8000806A5ACD556B2F9932CC2C3E504B00820033662F4F4F8B008B4B008233660000008B'
  );
  ...
  function zoom() {
    ...
    function wheeled() {
      ...
      g.zoom(
        'mouse',
        constrain(translate(scale(t, k), mousePoint, mouseLocation), g.extent)
      );
  ...
  function conicEqualArea$1() {
    return conicProjection(conicEqualArea).scale(151).translate([480, 347]);
  }
  ...
  function albersUsa() {
    var cache,
      ...
      lower48 = albers(),
      lower48Point,
      alaska = conicEqualArea$1()
        .rotate([154, 0])
        .center([-2, 58.5])
        .parallels([55, 65]),
      alaskaPoint, // EPSG:3338
      hawaii = conicEqualArea$1()
        .rotate([157, 0])
        .center([-3, 19.9])
        .parallels([8, 18]),
  ...
  function conicEquidistant$1() {
    return conicProjection(conicEquidistant).scale(128).translate([480, 280]);
  }
  ...
  function gnomonic$1() {
    return projection(gnomonic).scale(139).clipAngle(60);
  }
  ...
  function stereographic$1() {
    return projection(stereographic).scale(240).clipAngle(142);
  }
