...
# ---------------------------------------------------------------------- Upload
gem 'dradis-acunetix', github: 'dradis/dradis-acunetix', branch: 'mappings-manager/add-uploaders'
gem 'dradis-brakeman', github: 'dradis/dradis-brakeman', branch: 'mappings-manager/add-uploaders'
gem 'dradis-burp', github: 'dradis/dradis-burp', branch: 'mappings-manager/add-uploaders'
gem 'dradis-coreimpact', github: 'dradis/dradis-coreimpact', branch: 'mappings-manager/add-uploaders'
gem 'dradis-metasploit', github: 'dradis/dradis-metasploit', branch: 'mappings-manager/add-uploaders'
gem 'dradis-nessus', github: 'dradis/dradis-nessus', branch: 'mappings-manager/add-uploaders'
gem 'dradis-netsparker', github: 'dradis/dradis-netsparker', branch: 'mappings-manager/add-uploaders'
gem 'dradis-nexpose', github: 'dradis/dradis-nexpose', branch: 'mappings-manager/add-uploaders'
gem 'dradis-nikto', github: 'dradis/dradis-nikto', branch: 'mappings-manager/add-uploaders'
gem 'dradis-nipper', github: 'dradis/dradis-nipper', branch: 'mappings-manager/add-uploaders'
gem 'dradis-nmap', github: 'dradis/dradis-nmap', branch: 'mappings-manager/add-uploaders'
gem 'dradis-ntospider', github: 'dradis/dradis-ntospider', branch: 'mappings-manager/add-uploaders'
gem 'dradis-openvas', github: 'dradis/dradis-openvas', branch: 'mappings-manager/add-uploaders'
gem 'dradis-qualys', github: 'dradis/dradis-qualys', branch: 'mappings-manager/add-uploaders'
gem 'dradis-saint', github: 'dradis/dradis-saint', branch: 'mappings-manager/add-uploaders'
gem 'dradis-veracode', github: 'dradis/dradis-veracode', branch: 'mappings-manager/add-uploaders'
gem 'dradis-wpscan', github: 'dradis/dradis-wpscan', branch: 'mappings-manager/add-uploaders'
gem 'dradis-zap', github: 'dradis/dradis-zap', branch: 'mappings-manager/add-uploaders'
