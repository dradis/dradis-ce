...
gem 'dradis-burp', github: 'dradis/dradis-burp', branch: 'mappings-manager/legacy-mapping-reference'
...
gem 'dradis-qualys', github: 'dradis/dradis-qualys', branch: 'mappings-manager/legacy-mapping-reference'
