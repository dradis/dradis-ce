...
ActiveRecord::Schema[8.0].define(version: 2026_06_24_151000) do
  ...
  create_table "dradis_plugins_echo_providers", force: :cascade do |t|
    t.string "address"
    t.text "api_key"
    t.string "model"
    t.string "name", null: false
  ...
  create_table "editing_sessions", force: :cascade do |t|
    ...
    t.index ["record_type", "record_id"], name: "index_editing_sessions_on_record_type_and_record_id"
